...
UUID=${UUID:-'548ae475-8280-4d2b-85c2-52e867964409'}
VMESS_WSPATH=${VMESS_WSPATH:-'/548ae475-8280-4d2b-85c2-52e867964409-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/548ae475-8280-4d2b-85c2-52e867964409-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/548ae475-8280-4d2b-85c2-52e867964409-trojan'}
SS_WSPATH=${SS_WSPATH:-'/548ae475-8280-4d2b-85c2-52e867964409-shadowsocks'}
